//#region ../core/dist/default/i18n/locales/uk.js
var uk_default = {
	buttons: {
		play: "Відтворити",
		pause: "Призупинити",
	...
	errors: {
		...
		decode: "Відтворення відео було припинено через пошкодження або у зв'язку з тим, що відео використовує функції, які не підтримуються вашим браузером.",
...
//# sourceMappingURL=uk-Ca06VGNG.js.map