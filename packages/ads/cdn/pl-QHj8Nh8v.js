//#region ../core/dist/default/i18n/locales/pl.js
var pl_default = {
	buttons: {
		play: "Odtwórz",
		pause: "Wstrzymaj",
	...
	playback: { rate: "Prędkość odtwarzania {rate}" },
	volume: {
	...
	errors: {
		...
		decode: "Odtwarzanie materiału wideo zostało przerwane z powodu uszkodzonego pliku wideo lub z powodu użycia funkcji multimediów nieobsługiwanych przez Twoją przeglądarkę.",
		source: "Materiał wideo nie może zostać załadowany, ponieważ wystąpił problem z serwerem lub siecią albo format materiału wideo nie jest obsługiwany",
...
//# sourceMappingURL=pl-QHj8Nh8v.js.map