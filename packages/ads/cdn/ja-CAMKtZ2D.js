//#region ../core/dist/default/i18n/locales/ja.js
var ja_default = {
	buttons: {
		play: "再生",
		pause: "一時停止",
	...
	container: { label: "メディアプレイヤー" },
	errors: {
		aborted: "動画再生を中止しました",
		network: "ネットワーク エラーにより動画のダウンロードが途中で失敗しました",
		decode: "破損の問題、またはお使いのブラウザがサポートしていない機能が動画に使用されていたため、動画の再生が中止されました",
		source: "サーバーまたはネットワークのエラー、またはフォーマットがサポートされていないため、動画をロードできませんでした",
...
//# sourceMappingURL=ja-CAMKtZ2D.js.map