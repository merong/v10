//#region ../core/dist/default/i18n/locales/pt-PT.js
var pt_PT_default = {
	buttons: {
		play: "Reproduzir",
		pause: "Pausar",
	...
	container: { label: "Reprodutor multimédia" },
	errors: {
		aborted: "Parou a reprodução do vídeo.",
		network: "Um erro na rede fez o vídeo falhar parcialmente.",
		decode: "A reprodução foi interrompida por um problema com o vídeo ou porque o formato não é compatível com o seu navegador.",
		source: "O vídeo não pode ser carregado, ou porque houve um problema na rede ou no servidor, ou porque o formato do vídeo não é compatível.",
...
//# sourceMappingURL=pt-PT-BnqN-42M.js.map