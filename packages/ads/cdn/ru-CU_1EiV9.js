//#region ../core/dist/default/i18n/locales/ru.js
var ru_default = {
	buttons: {
		play: "Воспроизвести",
		pause: "Приостановить",
	...
	errors: {
		...
		decode: "Воспроизведение прервано из-за повреждения либо в связи с тем, что видео использует функции, неподдерживаемые вашим браузером.",
...
//# sourceMappingURL=ru-CU_1EiV9.js.map